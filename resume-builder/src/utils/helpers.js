...
import { TemplateOne, TemplateTwo } from "../assets";
...
export const TemplatesData = [
  { id: `template1-${Date.now()}`, name: "Template1", component: TemplateOne },
  { id: `template2-${Date.now()}`, name: "Template2", component: TemplateTwo },
];
